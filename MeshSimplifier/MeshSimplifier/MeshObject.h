/*
Class defining the total MeshObject
includes all its vertices, faces, and simplification/unsimplification functions
*/
#pragma once
...
public:
	...
	//Comparator to determine the vertex with the larget quadric error to be collapsed
	struct Comp;
	//custom container to store quadric data
